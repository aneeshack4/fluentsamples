...
public class FluentUITokens {
    public static let backgroundFillColorRest = globalColorGrey16
    public static let cardBaseCornerRadius = surfaceCornerRadius
    ...
    public static let surfaceCornerRadius = globalCornerRadiusMedium
    public static let globalColorGrey16 = UIColor(red: 0.161, green: 0.161, blue: 0.161, alpha:1)
    public static let globalColorGrey84 = UIColor(red: 0.839, green: 0.839, blue: 0.839, alpha:1)
    public static let globalColorWhite0 = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha:1)
    public static let globalCornerRadiusMedium = 4.0
}
